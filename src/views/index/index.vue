    ...
    <el-row :gutter="20">
      <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
        <el-alert v-if="noticeList[0]" :closable="noticeList[0].closable">
          ...
          >
            <a target="_blank" href="https://gitee.com/matevip/artemis">
              <img
                style="margin-right: 10px"
                src="https://img.shields.io/github/stars/matevip/matecloud?style=flat-square&label=Stars&logo=github"
              />
            </a>
            {{ noticeList[0].title }}
          </div>
        ...
        <el-card class="card" shadow="never">
          ...
          <div class="bottom-btn">
            <el-popover placement="top" width="250" trigger="hover">
              <p>欢迎加入微信和QQ群</p>
              <el-image
                src="https://cdn.ckjia.com/matecloud_social2.jpg"
              ></el-image>
            ...
            <a target="_blank" href="https://github.com/matevip/artemis">
      ...
      <el-col :xs="24" :sm="24" :md="12" :lg="12" :xl="12">
        <el-card shadow="never">
          ...
          <div style="text-align: center">
            <img :src="imgUrl" style="width: 160px" class="logo" />
            <h1 style="font-size: 30px">Artemis</h1>
          </div>
  ...
  export default {
    ...
    data() {
      return {
        ...
        imgUrl: require('@/assets/logo/mate-logo.png'),
        config1: {
          startVal: 0,
        ...
        noticeList: [
          {
            title:
              '温馨提示：Artemis 3.8.8正式发布，采用vue-admin-beautiful模板，基于element ui,为您提供更极致的体验。',
            closable: false,
            type: 'success',
          },
        ],
